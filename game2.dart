...
//--------------------------------------------Values are Fine, Moving Forward----------------------------------------------//
                                      ...
                                      BLE_Connection().write([2,time_chosen,color_chosen,3]),
                                      Navigator.push(
                                          context,
...
//---------------------------------------Finish Button-----------------------------------------//
            ElevatedButton(
              onPressed:!(widget.waiting) ? () async => {
                ...
                Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => Game2_Stats(actual_time: actual_time,homescreen: widget.homescreen, name: widget.name))),
              } : null, 
...
//------------------------------------------Collecting Statistics Data----------------------------------//
    ...
    int clicks = right_clicks + wrong_clicks;
                ...
                displayText(
                   Column(
                    ...
                    children: [
                      ...
                      Text("$right_clicks",style: Theme.of(context).textTheme.bodyMedium,)
                  ],),1
                ),
                const Spacer(),
//----------------------------------------------Wrong Clicks---------------------------------------------//
                displayText(
                   Column(
                    ...
                    children: [
                      ...
                      Text("$wrong_clicks",style: Theme.of(context).textTheme.bodyMedium,)
                  ],),2
                ),
                const Spacer(),
              ],),
